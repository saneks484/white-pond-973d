...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/white-pond-973d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/white-pond-973d
```

A live public deployment of this template is available at [https://white-pond-973d.templates.workers.dev](https://white-pond-973d.templates.workers.dev)
